...
class Batata extends StatefulWidget {
  const Batata({super.key});

  @override
  State<Batata> createState() => _BatataState();
}

class _BatataState extends State<Batata> {
  bool valor = true;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: const Text('Cultura da Batata')),
      body: Center(
          child: Column(
        children: [
          TextButton(
